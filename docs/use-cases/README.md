...
| UC-11   | Download Files                             | Download a single file or multiple files as a ZIP archive.        | `11-download-files.md`          |
...
| UC-20   | Preview File                               | Preview image, PDF, and text files directly in the browser.       | `20-preview-file.md`            |
...
| UC-23   | Configure Upload Limit                     | Set maximum allowed file size for uploads (admin/settings).       | `23-configure-upload-limit.md`  |
