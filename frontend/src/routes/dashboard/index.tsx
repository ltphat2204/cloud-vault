    ...
    <>
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <p className="text-[var(--sea-ink-soft)] mt-1 font-medium">
            Manage and access your secured files
          </p>
        </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div
            key={category.label}
            className="island-shell rounded-3xl p-6 transition-all hover:scale-[1.02] cursor-pointer"
          >
            <div
              className={`w-12 h-12 rounded-2xl ${category.color} flex items-center justify-center mb-4`}
            >
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-[var(--line)] bg-[var(--lagoon)]/5">
                <th className="px-6 py-4 text-xs font-bold tracking-wider text-[var(--sea-ink-soft)] uppercase">
                  Name
                </th>
                <th className="px-6 py-4 text-xs font-bold tracking-wider text-[var(--sea-ink-soft)] uppercase">
                  Type
            ...
            <tbody>
              {[
                ...
                <tr
                  key={file.name}
                  className="border-b border-[var(--line)] last:border-0 hover:bg-[var(--lagoon)]/5 transition-colors cursor-pointer"
                >
                  <td className="px-6 py-4 font-semibold text-[var(--sea-ink)]">
                    {file.name}
                  </td>
                  <td className="px-6 py-4 text-[var(--sea-ink-soft)] text-sm">
                    {file.type}
                  </td>
                  <td className="px-6 py-4 text-[var(--sea-ink-soft)] text-sm">
                    {file.size}
