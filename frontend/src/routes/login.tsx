    ...
    <div className="flex min-h-[calc(100vh-200px)] items-center justify-center px-4">
      <div className="island-shell rise-in w-full max-w-md rounded-[2rem] p-8 sm:p-10">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-[var(--sea-ink-soft)]">Enter your credentials to access your vault</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link to="/" className="text-xs font-medium text-[var(--lagoon-deep)] hover:underline">
                Forgot password?
              </Link>
            </div>
            <Input
        ...
        <div className="mt-8 text-center text-sm">
          ...
          <Link to="/register" className="font-bold text-[var(--lagoon-deep)] hover:underline">
            Create an account
          </Link>
        </div>
      </div>
